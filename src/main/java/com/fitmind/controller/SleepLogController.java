...
import com.fitmind.dto.sleep.SleepLogRequest;
import com.fitmind.entity.User;
import com.fitmind.service.SleepLogService;
...
public class SleepLogController {
    ...
    public ResponseEntity<ApiResponse<List<com.fitmind.entity.SleepLog>>> getHistory(
            @AuthenticationPrincipal User user,
