...
import com.fitmind.dto.water.WaterLogRequest;
import com.fitmind.entity.User;
import com.fitmind.service.WaterLogService;
...
public class WaterLogController {
    ...
    public ResponseEntity<ApiResponse<List<com.fitmind.entity.WaterLog>>> getHistory(
            @AuthenticationPrincipal User user,
